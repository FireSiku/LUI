						...
						Thanks = {
							...
							args = {
								...
								HighPatrons = {
									...
									type = "description",
									fontSize = "large",
									name = "|cffa335eeSkinny Man Music, Qoke, StephenFOlson, Fearon Whitcomb, Coy Linnerooth, Spencer Somers".."\n",
								},
								OtherPatrons = {
									order = 8,
									width = "full",
