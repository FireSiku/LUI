...
local function SetArchaeologyBar(_, value)
	db.General.ArchyBar = value
	module:ToggleArchy()
end
...
MirrorBar.args = {
	...
	General = Opt:Group({name = "General Settings", db = db.General, args = {
		...
		ArchyBar = Opt:Toggle({name = "Use LUI for Archaeology Progress", desc = "Show archaeology digsite progress in the LUI mirror-bar style instead of Blizzard's archaeology bar.", width = "full",
			get = function() return db.General.ArchyBar end, set = SetArchaeologyBar}),
	}}),
	Border = Opt:Group({name = "Border", db = db.Border, args = {
		Texture = Opt:MediaBorder({name = "Border Texture", desc = "Choose the Border Texture."}),
		Color = Opt:Color({name = "Border", desc = "Border", hasAlpha = true, db = db.Border}),
	...
	Colors = Opt:Group({name = "Bar Colors", db = db.Colors, args = {
		FatigueBar = Opt:Color({name = "Fatigue Bar", desc = "Fatigue Bar", hasAlpha = true}),
		BreathBar = Opt:Color({name = "Breath Bar", desc = "Breath Bar", hasAlpha = true}),
		FeignBar = Opt:Color({name = "Feign Death Bar", desc = "Feign Death Bar", hasAlpha = true}),
		Bar = Opt:Color({name = "Other Bar", desc = "Other Mirror Bars", hasAlpha = true}),
		ArchyBar = Opt:Color({name = "Archaeology Progress Bar", desc = "Archaeology Progress Bar", hasAlpha = true}),
		Background = Opt:Color({name = "Background", desc = "MirrorBar Background", hasAlpha = true}),
	}}),
