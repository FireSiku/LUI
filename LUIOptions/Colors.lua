...
Colors.Class.args = {
    ...
    EVOKER      = Opt:Color(classL["EVOKER"],      nil, 4),
    DRUID       = Opt:Color(classL["DRUID"],       nil, 5),
    HUNTER      = Opt:Color(classL["HUNTER"],      nil, 6),
    MAGE        = Opt:Color(classL["MAGE"],        nil, 7),
    MONK        = Opt:Color(classL["MONK"],        nil, 8),
    PALADIN     = Opt:Color(classL["PALADIN"],     nil, 9),
    PRIEST      = Opt:Color(classL["PRIEST"],      nil, 10),
    ROGUE       = Opt:Color(classL["ROGUE"],       nil, 11),
    SHAMAN      = Opt:Color(classL["SHAMAN"],      nil, 12),
    WARLOCK     = Opt:Color(classL["WARLOCK"],     nil, 13),
    WARRIOR     = Opt:Color(classL["WARRIOR"],     nil, 14),
...
Colors.Factions.args = {
    ...
    Kyrian =    Opt:Color(L["Kyrian"],      nil, 5),
    Necrolord = Opt:Color(L["Necrolord"],   nil, 6),
    NightFae =  Opt:Color(L["NightFae"],    nil, 7),
    Venthyr =   Opt:Color(L["Venthyr"],     nil, 8),
 
    LabelHeader = Opt:Header(L["Faction Labels"], 10),
    Standing1 = Opt:Color(STANDING_HATED,      nil, 11),
    Standing2 = Opt:Color(STANDING_HOSTILE,    nil, 12),
    Standing3 = Opt:Color(STANDING_UNFRIENDLY, nil, 13),
    Standing4 = Opt:Color(STANDING_NEUTRAL,    nil, 14),
    Standing5 = Opt:Color(STANDING_FRIENDLY,   nil, 15),
    Standing6 = Opt:Color(STANDING_HONORED,    nil, 16),
    Standing7 = Opt:Color(STANDING_REVERED,    nil, 17),
    Standing8 = Opt:Color(STANDING_EXALTED,    nil, 18),
}
-- luacheck: pop
