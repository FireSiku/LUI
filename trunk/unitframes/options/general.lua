...
function module:CreateUnitOptions(unit, order)
	...
	local options = self:NewGroup(unit, order * 2 + 10, "tab", nil, disabledUnitFunc, {
		...
		Bars = self:NewGroup("Bars", 3, "tab", nil, disabledFunc, {
			...
			Eclipse = (class == "DRUID" and unit == "Player" and not LUI.Legion) and self:CreatePlayerBarOptions("Eclipse", 17) or nil,
		...
		Texts = self:NewGroup("Texts", 4, "tab", nil, disabledFunc, {
			...
			Eclipse = (unit == "Player" and class == "DRUID" and not LUI.Legion) and self:CreatePlayerBarTextOptions("Eclipse", 11) or nil,
