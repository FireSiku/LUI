--[[
	Name........: DevAPI
	Description.: Compatibility helpers still used by legacy-namespace modules.
	              Chat submodules use GetDBVar/SetDBVar and LegacyToggle, so this
	              file cannot be removed until those callers are migrated.
]]
...
function devapi:LegacyToggle(state)
	if state == nil then
