...
function module:LoadOptions()
	...
	local ToggleCPoints = function(self, Enable)
		if not oUF_LUI_target.CPoints then oUF_LUI.funcs.CPoints(oUF_LUI_target, oUF_LUI_target.__unit, db.oUF.Target) end
		if Enable then
	...
	local ApplyCPoints = function()
		oUF_LUI.funcs.CPoints(oUF_LUI_target, oUF_LUI_target.__unit, db.oUF.Target)
		Forte:SetPosForte()
		oUF_LUI_target:UpdateAllElements()
	end
