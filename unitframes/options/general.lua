...
function module:CreateUnitOptions(unit, order)
	...
	local options = self:NewGroup(unit, order * 2 + 10, "tab", nil, disabledUnitFunc, {
		...
		Bars = self:NewGroup("Bars", 3, "tab", nil, disabledFunc, {
			...
			AltPower = IsRetail and (unit == "Player") and self:CreatePlayerBarOverlappingOptions("AltPower", 12) or nil,
			Runes = ((class == "DEATHKNIGHT" or class == "DEATH KNIGHT") and unit == "Player") and self:CreatePlayerBarOptions("Runes", 14) or nil,
			HolyPower = IsRetail and (class == "PALADIN" and unit == "Player") and self:CreatePlayerBarOptions("HolyPower", 15) or nil,
			WarlockBar = IsRetail and (class == "WARLOCK" and unit == "Player") and self:CreatePlayerBarOptions("WarlockBar", 16) or nil,
			ArcaneCharges = IsRetail and (class == "MAGE" and unit == "Player") and self:CreatePlayerBarOptions("ArcaneCharges", 16) or nil,
			Chi = IsRetail and ((class == "MONK" or class == "DRUID" or class == "ROGUE") and unit == "Player") and self:CreatePlayerBarOptions("Chi", 16) or nil,
		...
		Texts = self:NewGroup("Texts", 4, "tab", nil, disabledFunc, {
			...
			WarlockBar = IsRetail and (unit == "Player" and class == "WARLOCK") and self:CreatePlayerBarTextOptions("WarlockBar", 9) or nil,
			PvP = (unit == "Player") and self:CreatePvpTimerOptions(10) or nil,
			AltPower = IsRetail and (unit == "Player") and self:CreatePlayerBarTextOptions("AltPower", 12) or nil,
		}),
