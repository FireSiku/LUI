...
function module:CreateNameTextOptions(unit, order)
	...
	local disabledShortClassificationFunc = function() return not self.db[unit].Texts.Name.Enable or not self.db[unit].Texts.Name.ShowClassification end
	...
	local options = self:NewGroup("Name", 1, {
		...
		ShortClassification = self:NewToggle("Short Classifications", "Whether you want to show short Classifications or not.", 19, applyInfoText, nil, disabledShortClassificationFunc) or nil,
